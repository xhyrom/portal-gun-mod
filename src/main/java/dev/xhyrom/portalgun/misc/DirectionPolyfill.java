...
public class DirectionPolyfill {
    private static final Long2ObjectMap<Direction> BY_NORMAL = Arrays.stream(Direction.values()).collect(Collectors.toMap((p_122409_0_) -> {
